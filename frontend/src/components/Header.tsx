...
export default function Header({ newSession }: HeaderArgs) {
  return (
    <div className="m-4 flex items-center">
      ...
      <div>
        <button
          className="flex h-18 w-20 flex-col items-center rounded-2xl bg-linear-120 from-blue-800 to-blue-600 px-4 py-2 text-2xl text-blue-100 shadow-lg shadow-blue-900 hover:from-blue-700 hover:to-blue-500"
          onClick={newSession}
        >
